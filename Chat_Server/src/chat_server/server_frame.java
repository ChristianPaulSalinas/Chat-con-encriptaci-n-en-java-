...
public class server_frame extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable	
   {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(b_end, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(149, 149, 149)
                        .addComponent(b_start, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(43, 43, 43)
    ...
    private void b_endActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_endActionPerformed
        ...
        tellEveryone("Servidor:esat deteniendose y todos los usuarios se desconectaran.\n:Chat");
    ...
    public class ServerStart implements Runnable 
    {
        ...
        public void run() 
        {
            ...
            try 
            {
				...
				listener.start();
				ta_chat.append("Conexion obtenida. \n");
                }
            }
            catch (Exception ex)
            {
                ta_chat.append("Error haciendo la conexion. \n");
            }
        }
    }
    ...
    {
        String message, add = ": :Conectado", done = "Servidor: :Correcto", name = data;
	...
	Iterator it = clientOutputStreams.iterator();
		...
		ta_chat.append("Enviando: " + message + "\n");
            ...
            {
		ta_chat.append("Error al enviarle a todos. \n");
            }
        } 
    }
